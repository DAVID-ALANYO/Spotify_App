...
export default function App ({navigation}) {
  ...
  return (
    ...
    <NavigationContainer>
      ...
      <View style={styles.Library_Bar1}>
      <TouchableOpacity>
        <Image source={require('./Images/search.png')} style={{width:20,height:20,marginRight:15}}/>
        </TouchableOpacity>
        <TouchableOpacity>
        <Image source={require('./Images/plus.png')} style={{width:20,height:20,marginRight:16}}/>
        </TouchableOpacity>
      </View>
      </View>
